...
import { useWebSocket } from "../infra/libs";

import { MessageModel, MessageAction } from "../../backend/types";
...
export const WSProvider = ({
  ...
  const sendMessage = <T extends MessageModel>(message: T) =>
    sendJsonMessage(message);
  return (
    <WSContext.Provider value={{ gs, sendMessage }}>
      {children}
    </WSContext.Provider>
  );
};
