...
import { GetUserModel  } from '../../../types';
import { GetUserComposer } from '../../../main/composer/user';
...
export const handler = async (event: APIGatewayProxyEvent): Promise<APIGatewayProxyResult> => {
  ...
  try {
    if (body) {
      const action : GetUserModel = parseBody(body);
      const data = await GetUserComposer.compose(headers.authorization!)
