...
export type OutputGet =  { nome: string, email: string, idPerfil: number, nomePerfil: string, tipoPessoa: string, cpfCnpj: string | null, telefone: string, ativo: boolean }
...
export type OutputUpdateAddress = { idEndereco: number, tipo: string, nome: string, logradouro: string, numero: number, cep: string, bairro: string, cidade: string, complemento: string | null, telefone: string, selecionado: boolean, dataCadastro: Date, dataAlteracao: Date }
